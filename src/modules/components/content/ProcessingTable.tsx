    ...
    content: [
      {
        ...
        basis: `Contractual necessity<br/>
      ...
      (We collect feedback and analyze metrics and outcomes so that we can show our impact and improve Name.)`,
      },
      {
      ...
      },
      {
        ...
        basis: `Legitimate Interests
      (We may use data to help target ads promoting Name and to measure the effectiveness of those ads.)`,
      },
      {
      ...
      },
      {
        ...
        basis: `Legitimate Interests
      (We share your info with vetted matchmaking organizations and vendors, with whom we have appropriate written agreements, to help us operate Name.)`,
      },
      {
        activity: 'Share Your Info with Organizations',
        basis: `Consent
      (We ask for your permission to share your info with Organizations so that you're only contacted by ones you're actually interested in.)`,
      },
      {
        activity: 'Others',
        basis: `We can't imagine every possible scenario, so if we need to use your data for another purpose, we'll let you know!`,
      },
    ],
  };
        ...
        {tableData.content.map((contentRow, i) => (
          <tr key={i} className="bg-white">
            ...
            <td
              ...
              dangerouslySetInnerHTML={{ __html: contentRow.basis }}
            ></td>
          </tr>
        ))}
      </tbody>
