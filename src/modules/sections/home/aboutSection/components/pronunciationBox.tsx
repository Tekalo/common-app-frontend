...
const PronunciationBox: React.FC = () => (
  <div className="relative mx-auto max-w-[445px]">
    {/* Main content bg */}
    ...
    {/* Text container */}
    <div className="m-auto mb-16 p-5 lg:mb-20 lg:max-w-[544px]">
      <div className="relative z-30 space-y-3 text-p2-mobile md:space-y-6 lg:text-p2-desktop">
        <div>
        ...
        <div>{HOME_ABOUT_TEXT.PRONUNCIATION.GOAL}</div>
      </div>
    </div>
  </div>
);
