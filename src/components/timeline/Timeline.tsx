    ...
    <div className="px-96 pt-14">
      <ol className="-space-y-7">
        {timelineItems.map((item, i) => (
          <li
            key={i}
            className="border-l-2 border-solid border-blue-1-primary pb-8 last:border-l-0"
          >
            <div className="flex-start flex items-center">
              <div className="-ml-[30px] flex h-14 w-14 items-center justify-center rounded-full bg-blue-1-primary text-center font-display text-component-xl text-white-text">
                {i + 1}
              </div>
