          ...
          <div className="flex items-center space-x-2 md:space-x-6 lg:space-x-10">
            {isLoading ? (
              ...
              <div className="flex flex-auto animate-pulse flex-row space-x-4">
                <div className="bg-slate-700 hidden rounded px-12 py-3 md:block" />
                <div className="bg-slate-700 rounded px-12 py-3 md:px-8 lg:px-12" />
                <div className="bg-slate-700 flex h-6 w-6 items-center rounded md:hidden"></div>
              </div>
            ) : (
              <>
                <a
